...
export const createMyFiniteStateMachineType = async (
  ...
  const transitionEventType = addressSpace.findNode(
    "ns=0;i=2311",
  ) as UAEventType;
  const modellingRuleRef = addressSpace.findNode(
    "ns=0;i=37",
  ) as UAReferenceType;
  const modellingRuleMandatory = addressSpace.findNode("ns=0;i=78");

  const initState = namespace.addState(
  ...
  //     })
  // }
  const processingState = namespace.addState(
    myFiniteStateMachine,
    "Processing",
    400,
  );
  ...
  const initToIdle = namespace.addTransition(
    myFiniteStateMachine,
    "Initializing",
    "Idle",
    1,
  ...
  //     })
  // }
  const idleToPrepare = namespace.addTransition(
    myFiniteStateMachine,
    "Idle",
    "Prepare",
    2,
  ...
  //     })
  // }
  const prepareToProcessing = namespace.addTransition(
    myFiniteStateMachine,
    "Prepare",
    "Processing",
    3,
  ...
  //     })
  // }
  const processingToDone = namespace.addTransition(
    myFiniteStateMachine,
    "Processing",
    "Done",
    4,
  ...
  //     })
  // }
  const doneToIdle = namespace.addTransition(
    myFiniteStateMachine,
    "Done",
    "Idle",
    5,
