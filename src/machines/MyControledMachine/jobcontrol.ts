...
export const createJobContolLogic = async (addressSpace: AddressSpace): Promise<void> => {
        ...
        JobOrderResults.raiseEvent(
            MyControledMachineJobOrderResultStatusEventType,
            {
                jobOrder: new Variant({
                    value: addressSpace.constructExtensionObject(ISA95JobOrderDataType, (job!.jobOrder as any)), 
    ...
    function startJobOrder(JobOrderId: string, Comment: LocalizedText[]): ISA95_Method_ReturnCode {
        if (JobOrderMap.has(JobOrderId) === false) {
            yellow(`JobOrderControl(MyControledMachine): Unknown JobOrderId='${JobOrderId}'`)
    ...
    function updateJobOrder(JobOrder: ISA95JobOrderDataType, Comment: LocalizedText[]): ISA95_Method_ReturnCode {
        if (JobOrderMap.has(JobOrder.jobOrderID) === false) {
            yellow(`JobOrderControl(MyControledMachine): Unknown JobOrderId='${JobOrder.jobOrderID}'`)
            return ISA95_Method_ReturnCode.UnknownJobOrderId
        }
    ...
    function storeJobOrder(JobOrder: ISA95JobOrderDataType, Comment: LocalizedText[]): ISA95_Method_ReturnCode {
        ...
        */
        if (JobOrderMap.has(JobOrder.jobOrderID)) {
            yellow(`JobOrderControl(MyControledMachine): JobOrderId='${JobOrder.jobOrderID}' already exist!`)
    ...
    StoreAndStart.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).StoreAndStart: sessionId='${context.session?.getSessionId()} jobOrderId='${(inputArguments[0].value as ISA95JobOrderDataType).jobOrderID}'`)
        try {
            let rc 
    ...
    Store.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).Store: sessionId='${context.session?.getSessionId()}' jobOrderId='${(inputArguments[0].value as ISA95JobOrderDataType).jobOrderID}'`)
        try {
    ...
    Start.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).Start: sessionId='${context.session?.getSessionId()}' jobOrderId='${inputArguments[0].value}'`)
        try {
    ...
    Update.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).Update: sessionId='${context.session?.getSessionId()}' jobOrderId='${(inputArguments[0].value as ISA95JobOrderDataType).jobOrderID}'`)
        try {
    ...
    Stop.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).Stop: sessionId='${context.session?.getSessionId()}' jobOrderId='${inputArguments[0].value}'`)
        try {
    ...
    Cancel.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).Cancel: sessionId='${context.session?.getSessionId()}' jobOrderId='${inputArguments[0].value}'`)
        try {
    ...
    Clear.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).Clear: sessionId='${context.session?.getSessionId()}' jobOrderId='${inputArguments[0].value}'`)
        try {
    ...
    RevokeStart.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).RevokeStart: sessionId='${context.session?.getSessionId()}' jobOrderId='${inputArguments[0].value}'`)
        try {
    ...
    Pause.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).Pause: sessionId='${context.session?.getSessionId()}' jobOrderId='${inputArguments[0].value}'`)
        try {
    ...
    Abort.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).Abort: sessionId='${context.session?.getSessionId()}' jobOrderId='${inputArguments[0].value}'`)
        try {
    ...
    Resume.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        ...
        */
        green(`JobOrderControl(MyControledMachine).Resume: sessionId='${context.session?.getSessionId()}' jobOrderId='${inputArguments[0].value}'`)
        try {
    ...
    const RequestJobResponseByJobOrderID = JobOrderResults.getMethodByName("RequestJobResponseByJobOrderID") as UAMethod
    RequestJobResponseByJobOrderID.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        /*
    ...
    const RequestJobResponseByJobOrderState = JobOrderResults.getMethodByName("RequestJobResponseByJobOrderState") as UAMethod
    RequestJobResponseByJobOrderState.bindMethod(function (this: UAMethod, inputArguments: Variant[], context: ISessionContext, callback: CallbackT<CallMethodResultOptions>): void {
        /*
            This Method is used to return Job Responses for unsolicited requests for responses from a job order.
