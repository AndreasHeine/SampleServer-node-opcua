...
config.alternateHostname =
  process.env.HOSTNAMES?.split(",") || configJsonObj.alternateHostname || [];
...
config.buildInfo.buildDate = new Date(
  String(configJsonObj.buildInfo?.buildDate),
);
